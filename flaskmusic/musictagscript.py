...
def get_meta(folder, file):
    if not os.path.isdir(os.path.join(f'{folder}', 'album')):
        os.mkdir(os.path.join(f'{folder}', 'album'))
...
get_meta('static/music', 'Shakka_-_When_Will_I_See_You_Again_AMTRAC_Remix.m4a')
